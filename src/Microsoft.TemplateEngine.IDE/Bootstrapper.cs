...
namespace Microsoft.TemplateEngine.IDE
{
    public class Bootstrapper : IDisposable
    {
        ...
        /// <param name="onFirstRun">action to perform on the first run of template engine host.</param>
        ...
        public Bootstrapper(ITemplateEngineHost host, Action<IEngineEnvironmentSettings> onFirstRun, bool virtualizeConfiguration, bool loadDefaultComponents = true)
        {
