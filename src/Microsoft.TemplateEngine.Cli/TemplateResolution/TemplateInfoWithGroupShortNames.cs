...
namespace Microsoft.TemplateEngine.Cli.TemplateResolution
{
    ...
    /// </summary>
    internal class TemplateInfoWithGroupShortNames : ITemplateInfo, ITemplateInfoWithHostJsonCache
    {
        ...
        public JObject? HostData => (_parent as ITemplateInfoWithHostJsonCache)?.HostData;
